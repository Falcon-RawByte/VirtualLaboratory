		...
		return (
					<div id="preset1" className="presetBlock">
						...
						<div className="presetButtonContainer">
							<button type="button" className="btn btn-primary presetButton" onClick={this._load}>Load</button>
							<button type="button" className="btn btn-danger presetButton" onClick={this._delete}>Delete</button>
						</div>
					</div>
			);
	}
