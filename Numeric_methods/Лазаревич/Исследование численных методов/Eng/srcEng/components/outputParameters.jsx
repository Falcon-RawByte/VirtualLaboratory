...
class OutputParameters extends React.Component
{
	...
	render(){
		...
		return (
			...
			<div id="outputParametersLabel" className="componentLabel">Output parameters</div>
			<div id="outputParametersContent">
				<div style={{display:'table',borderSpacing:'5px'}}>
					<div className="table_row">		
					<label className="table_label">Error calculation</label>
				 	<select id="outputMainMethod" name="errorMethod" style={{width:"300px"}} onChange={this._updateParameter} value={this.state.parameters.errorMethod}>
				 		<option value="-1">Is not needed</option>
				 		{methodList}
				 	</select>
					</div>
					<div className="table_row">						
						<label className="table_label" htmlFor="errors_input">Local and global error plots</label>
					...
					<div className="table_row">
						<label className="table_label" htmlFor="eigenvalue_input">Plot of eigenvalues</label>
