...
class ExplicitRK8
{
	constructor()
	{
		...
		this.a=[
			...
			[0,0,0,0,(-42+7*root)/18,(-18+28*root)/45,(-27353*root)/72,(301+53*root)/72,(28-28*root)/72,(49-7*root)/18]];
...
ExplicitRK6_1.attributes={name:'Explicit Runge-Kutta 8th order method'};
