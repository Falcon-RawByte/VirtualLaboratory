...
class TaskParameters extends React.Component
{
	...
	render()
	{
		...
		return (	
				...
				{	params.length!=0&&
					<div>
					<div id="taskParameters" className="componentLabel">Параметры системы</div>
					...
					<div id="taskInitials" className="componentLabel">Начальные условия и интервал расчёта</div>
					<div style={{display:'table',borderSpacing:'5px'}}>
					<div className="table_row_group">
					{variables}
